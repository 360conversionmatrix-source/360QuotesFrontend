...
const RoofingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://quotes-bdjj.onrender.com/roofing/submit", {
        method: "POST",
  ...
  <img 
    src="https://res.cloudinary.com/diicgo6ay/image/upload/v1788443290/pngtree-young-roofing-contractor-nailing-shingles-on-a-roof-high-above-the-image_15667784_1_oq4dtr.jpg" 
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
    <h1 className="text-3xl pt-32 md:pt-7 md:text-7xl font-bold text-white">Roofing</h1>
    <h1 className="sm:mt-4  text-xl sm:text-3xl text-white">
       Get Roofing Quotes from Trusted Providers
    </h1>
  </div>
</header>
