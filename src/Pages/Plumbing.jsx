...
const PlumbingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://quotes-bdjj.onrender.com/plumbing/submit", {
        method: "POST",
  ...
  <img 
    src="https://res.cloudinary.com/diicgo6ay/image/upload/v1788443142/premium_photo-1683141410787-c4dbd2220487_1_y6rhnh.jpg" 
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
    <h1 className="text-3xl pt-32 md:pt-7 md:text-7xl font-bold text-white">Plumbing</h1>
    <h1 className="sm:mt-4  text-xl sm:text-3xl text-white">
       Get Plumbing Quotes from Trusted Providers
    </h1>
  </div>
</header>
