        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start gap-3 mt-6 text-xs text-gray-500 leading-relaxed">
            ...
            <label htmlFor="subscribe">
              ...
              <Link to="/privacy" className="text-[#0685B1] underline"> Privacy Policy</Link> and authorize Pest control Companies and their agents and marketing partners to contact me about Pest Control and other non-insurance offers by telephone calls and text messages to the number I provided above. I agree to receive telemarketing calls and pre-recorded messages via an autodialed phone system, even if my telephone number is a mobile number that is currently listed on any state, federal or corporate “Do Not Call” list. I understand that I may revoke my consent at any time and that my consent is not a condition of purchase of any goods or services and that standard message and data rates may apply for California Residents.
            </label>
          </div>
