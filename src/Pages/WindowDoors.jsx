...
const WindowDoors = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://quotes-bdjj.onrender.com/windowsDoors/submit", {
        method: "POST",
  ...
  <img 
    src="https://res.cloudinary.com/diicgo6ay/image/upload/v1787675523/How-to-Compare-Window-Replacement-Quotes-in-Toronto-2026-3983329835_1_bbm1oq.jpg" 
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
    <h1 className="text-3xl pt-32 md:pt-7 md:text-7xl font-bold text-white">Windows & Doors</h1>
    <h1 className="sm:mt-4  text-xl sm:text-3xl text-white">
       Get Windows Repair & Replacement Quotes from Trusted Providers
    </h1>
  </div>
</header>
